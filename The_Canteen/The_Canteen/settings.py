"""
Django settings for The_Canteen project.
...
# SECRET_KEY = 'django-insecure-nsnk&%evcuircxogb@xupo#55j2*kto8a^go-r!19pmth-5qnx'
...
WSGI_APPLICATION = 'The_Canteen.wsgi.application'
